...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/black.jpg")';
            //active player may only be 'X' or 'O' so if not 'X' it must be 'O'
        } else {
            //if activePlaye is equal to 'O' the o.png is placed in HTML
        ...
        checkWinConditions();
        //this conditio is for changing the active player
        if (activePlayer === 'X') {
...
function checkWinConditions() {
    ...
    //this function checks if an array includes 3 strings. It is used to check fot each win condition
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++ ) {
        //this variable gets the HTML elememt i
